...
def _urlopen(url: str, timeout: int = 10) -> HTTPResponse:
    """Open an HTTP GET with the project User-Agent and a timeout.

    Thin wrapper used by strategy_api for external sentiment endpoints.
    """
