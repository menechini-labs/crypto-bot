...
POSITIVE = [
    "surge", "rally", "gain", "gains", "soar", "soars", "jump", "jumps", "bull", "bullish",
    "breakout", "record", "high", "adoption", "approval", "approved", "upgrade", "optimistic",
    "recovery", "pump", "moon", "buy", "profit", "profits",
]
NEGATIVE = [
    "crash", "plunge", "drop", "drops", "fall", "falls", "bear", "bearish", "hack", "hacked",
    "exploit", "scam", "fraud", "ban", "banned", "lawsuit", "sec", "fed", "dump", "sell-off",
    "selloff", "loss", "losses", "collapse", "fear", "warning", "warn", "downgrade", "liquidation",
    "liquidated", "default", "bankrupt", "fud",
]
# Impact: mentions of major assets or macro events raise impact flag.
HIGH_IMPACT = [
    "bitcoin", "btc", "ethereum", "eth", "sec", "fed", "federal reserve", "inflation", "gdp",
    "interest rate", "rate hike", "etf", "halving", "binance", "coinbase", "regulation",
]
...
def fetch_news(per_feed: int = 15, sources: Optional[List[str]] = None) -> List[NewsItem]:
